...
const { createCategory, updateCategory, getCategoryByRestaurantId, getCategoryById, getCategoryImage } = require('../../src/database/models/foods/categories-simple.cjs');
...
const { 
  ...
  deleteFood,
  getFoodImage
} = require('../../src/database/models/foods/food-simple.cjs');
