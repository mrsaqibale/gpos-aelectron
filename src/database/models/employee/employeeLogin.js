...
const getDynamicPath = (relativePath) => {
  try {
    ...
    console.log(`[employeeLogin.js] Looking for: ${relativePath}`);
    console.log(`[employeeLogin.js] Current dir: ${__dirname}`);
    console.log(`[employeeLogin.js] isBuiltApp: ${isBuiltApp}`);
    console.log(`[employeeLogin.js] Dev path: ${devPath}`);
    console.log(`[employeeLogin.js] Built path: ${builtPath}`);
    
    if (isBuiltApp && process.resourcesPath && fs.existsSync(builtPath)) {
      console.log(`✅ [employeeLogin.js] Found at built path: ${builtPath}`);
      return builtPath;
    } else if (fs.existsSync(devPath)) {
      console.log(`✅ [employeeLogin.js] Found at dev path: ${devPath}`);
      return devPath;
    } else {
      console.log(`❌ [employeeLogin.js] Not found, using dev path: ${devPath}`);
      return devPath;
    }
  } catch (error) {
    console.error(`[employeeLogin.js] Failed to resolve path: ${relativePath}`, error);
