...
const getDynamicPath = (relativePath) => {
  try {
    ...
    console.log(`[allergins.js] Looking for: ${relativePath}`);
    console.log(`[allergins.js] Current dir: ${__dirname}`);
    console.log(`[allergins.js] isBuiltApp: ${isBuiltApp}`);
    console.log(`[allergins.js] Dev path: ${devPath}`);
    console.log(`[allergins.js] Built path: ${builtPath}`);
    
    if (isBuiltApp && process.resourcesPath && fs.existsSync(builtPath)) {
      console.log(`✅ [allergins.js] Found at built path: ${builtPath}`);
      return builtPath;
    } else if (fs.existsSync(devPath)) {
      console.log(`✅ [allergins.js] Found at dev path: ${devPath}`);
      return devPath;
    } else {
      console.log(`❌ [allergins.js] Not found, using dev path: ${devPath}`);
      return devPath;
    }
  } catch (error) {
    console.error(`[allergins.js] Failed to resolve path: ${relativePath}`, error);
