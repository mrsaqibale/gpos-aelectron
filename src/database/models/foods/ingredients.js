...
const getDynamicPath = (relativePath) => {
  try {
    ...
    console.log(`[ingredients.js] Looking for: ${relativePath}`);
    console.log(`[ingredients.js] Current dir: ${__dirname}`);
    console.log(`[ingredients.js] isBuiltApp: ${isBuiltApp}`);
    console.log(`[ingredients.js] Dev path: ${devPath}`);
    console.log(`[ingredients.js] Built path: ${builtPath}`);
    
    if (isBuiltApp && process.resourcesPath && fs.existsSync(builtPath)) {
      console.log(`✅ [ingredients.js] Found at built path: ${builtPath}`);
      return builtPath;
    } else if (fs.existsSync(devPath)) {
      console.log(`✅ [ingredients.js] Found at dev path: ${devPath}`);
      return devPath;
    } else {
      console.log(`❌ [ingredients.js] Not found, using dev path: ${devPath}`);
      return devPath;
    }
  } catch (error) {
    console.error(`[ingredients.js] Failed to resolve path: ${relativePath}`, error);
