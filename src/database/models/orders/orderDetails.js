...
export function createOrderDetail(orderDetailData) {
  try {
    ...
    const values = [
      ...
      orderDetailData.quantity !== null && orderDetailData.quantity !== undefined ? orderDetailData.quantity : 1,
    ...
    const insertMany = db.transaction((details) => {
      ...
      for (const detail of details) {
        const values = [
          ...
          detail.quantity !== null && detail.quantity !== undefined ? detail.quantity : 1,
          detail.tax_amount || 0,
