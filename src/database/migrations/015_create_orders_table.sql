CREATE TABLE IF NOT EXISTS orders (
    ...
    order_number TEXT,
    placed_at DATETIME,
    delivery_tax_percentage REAL DEFAULT 0,
    delivery_tax_amount REAL DEFAULT 0,
    food_tax_amount REAL DEFAULT 0,
    service_tax_amount REAL DEFAULT 0,
    service_tax_percentage REAL DEFAULT 0,
    service_name TEXT,
    payment_method1_amount REAL DEFAULT 0,
    payment_method2 TEXT,
    payment_method2_amount REAL DEFAULT 0,
