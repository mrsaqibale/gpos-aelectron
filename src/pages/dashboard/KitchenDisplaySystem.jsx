...
const KitchenDisplaySystem = () => {
  ...
  const tabs = [
    ...
    { key: "new", label: "New", icon: BadgePlus, style: { backgroundColor: themeColors.primary } },
    { key: "preparing", label: "In-Preparation", icon: CookingPot, style: { backgroundColor: themeColors.primary } },
    { key: "ready", label: "Ready", icon: CheckCircle, style: { backgroundColor: themeColors.primary } },
  ];
          ...
          {tabs.map((tab) => {
            ...
            return (
              <button
                ...
                className={`items-center text-white btn-lifted rounded-md px-2 py-3 gap-2 font-semibold flex tabs-center justify-center cursor-pointer hover:opacity-80 transition-opacity`}
                style={tab.style || (tab.bgColor ? { backgroundColor: tab.bgColor } : {})}
              >
                <Icon size={16} />
                {tab.label}
              </button>
