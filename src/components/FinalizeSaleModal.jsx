  ...
  return (
    <div className="fixed inset-0 bg-[#00000089] bg-opacity-30 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-4xl max-h-[90vh] flex flex-col">
        ...
        <div className="border-t border-gray-200 p-6 flex flex-col gap-3 justify-center items-center">
          {/* Discount Button */}
          <button
              className="px-3 mb-4 py-2 w-[200px] bg-green-600 text-white rounded-lg flex items-center justify-center gap-2 text-lg font-semibold"
            >
              <Gift size={20} />
              Discount
            </button>
          <div className="grid grid-cols-3 gap-4">
            ...
            <button
              onClick={onClose}
              className="px-3 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-colors flex items-center justify-center gap-2 text-lg font-semibold"
            >
            ...
            <button
              ...
              className={`px-3 py-2 rounded-lg transition-colors flex items-center justify-center gap-2 text-lg font-semibold ${
                (() => {
                  const remainingAmount = Math.max(0, (
                    isSinglePayMode ? calculateSinglePayTotals().total :
                    selectedSplitBill ? calculateSplitBillTotal() : calculateCartTotal()
            ...
            <button
              onClick={onClose}
              className="px-3 py-2 bg-yellow-600 text-white rounded-lg hover:bg-yellow-700 transition-colors flex items-center justify-center gap-2 text-lg font-semibold"
            >
              <Clock size={20} />
              PAY LATER
            </button>
